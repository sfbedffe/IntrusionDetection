...
data_encoded_test = data_encoded.iloc[-22544:, :]
# 数据归一化
Scaler = MinMaxScaler()
...
label_binary_encoded_test = label_binary_encoded.iloc[-22544:, :]
label_multip_encoded_train = label_multip_encoded.iloc[:125973, :]
label_multip_encoded_test = label_multip_encoded.iloc[-22544:, :]
